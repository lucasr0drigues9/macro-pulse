...
- 2026-04-06 — Added Simple Version section to /europe page with four core positions (NATO ETF, IOGP, ASML, NHY). Rationale: most users want simple actionable positions not 25 individual stocks. Detailed sector cards remain below for deeper research. Also added Nordnet buying guide and performance tracking placeholder.
- 2026-04-06 — Added Safran (SAF.PA) to European Strategic Autonomy tracker in both Defence and Technology sectors. Rationale: unique dual sovereign capability in aerospace propulsion and space — the most irreplaceable single company in the European autonomy thesis.
