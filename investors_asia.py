...
INVESTORS = [
    {"name": "Hillhouse Capital",    "cik": "0001510589", "weight": 1.4},
    {"name": "Greenwoods Asset Mgmt","cik": "0001848138", "weight": 1.1},
    {"name": "Aspex Management",     "cik": "0001768375", "weight": 1.0},
]
...
def parse_holdings(cik: str, accession: str) -> tuple[dict, float]:
    ...
    # Try xml parser first (handles ns1: namespaces), fall back to html.parser
