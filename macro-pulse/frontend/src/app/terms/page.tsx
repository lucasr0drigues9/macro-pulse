    ...
    <main className="min-h-screen px-4 py-16 max-w-3xl mx-auto">
      ...
      <div className="space-y-8 text-sm text-[#888] leading-relaxed">
        <section>
          ...
          <p>
            By accessing and using Macro World View, you acknowledge that this is an educational and
        ...
        <section>
          ...
          <p>
            Macro World View and its creators shall not be liable for any losses, damages, or expenses
        ...
        <section>
          ...
          <p>
            The presentation, code, and analysis methodology of Macro World View are original work.
