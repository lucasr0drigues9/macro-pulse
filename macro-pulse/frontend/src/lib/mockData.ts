...
export const assetPerformance = {
  ...
  assets: [
    ...
    { ticker: "XLP", name: "Consumer Staples SPDR", returnPct: 4.1, category: "neutral" as const },
...
export const playbookData: Record<RegimeName, {
  ...
  Deflation: {
    ...
    outperform: [
      { asset: "Gold (GLD)", why: "Best average return in Deflation at +5.9%. Store of value when financial system stress rises." },
      { asset: "US Aggregate Bond (AGG)", why: "Most consistent deflation asset — +2.0% avg, worst case only -6.2%, positive 86% of the time. Safer than long bonds." },
      { asset: "Fidelity MSCI IT (FTEC)", why: "Recovery upside — AI winners rebound first as rate cuts fuel growth expectations." },
      { asset: "Cash", why: "Purchasing power increases as prices fall. The framework holds higher cash reserves in this regime." },
    ],
    underperform: [
      { asset: "Long Bonds (TLT)", why: "Dangerous when the Fed is hiking during deflation — lost 20% in 2023. Only works when rates are being cut. Too risky as a core deflation holding." },
      { asset: "Energy (XLE)", why: "Falling demand crushes energy prices. Worst average at -5.2%." },
