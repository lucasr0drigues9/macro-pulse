          ...
          <form onSubmit={handleSubmit}>
            ...
            <label className="flex items-center gap-2 text-xs text-[#555] mt-3 cursor-pointer">
              <input
                ...
                className="rounded"
              />
              Also send me the Weekly Macro World View every Tuesday
            </label>
          </form>
        )}
        ...
        {phase === "missing" && (
          <div className="max-w-md mx-auto py-2 text-left">
            ...
            <ul className="text-xs text-[#888] space-y-1.5 mb-3 list-disc list-inside">
              ...
              <li>Still nothing after 5 minutes? Email <b className="text-[#e0e0e0]">hello@macroworldview.com</b> directly</li>
            </ul>
